...
@Getter
public class ConvolutionService extends Service {
    private static final String fxmlConvolutionFileName = "fxml/signalConvolutionDialog.fxml";
    private MainWindowService mainWindowService;
    private final SignalView signalView;
    private Stage dialog;

    public ConvolutionService(MainWindowService mainWindowService, SignalView signalView) {
        this.mainWindowService = mainWindowService;
        this.signalView = signalView;
        dialog = new Stage();
        dialog.initOwner(mainWindowService.getStage());
        createScene(dialog, fxmlConvolutionFileName);
    }
    ...
    public void createNewSignalByConvolution(String newName, SignalView selectedSignal) {
        ...
        List<Point> resultPoints = signalConvolution.convolution(firstPoints,secondPoints,timeStep);
